...
public class INGCollege implements ActionListener 
{
    ...
    public INGCollege()
    {
        ...
        //Initializing Label for Academic Course
        ...
        //Initializing Label for Non Academic Course
       ...
       //Initializing Textfield for Academic Course     
        ID=new JTextField();
        ...
        //Initializing textfield for Non Academic Course    
        nID=new JTextField();
  ...
  public void actionPerformed(ActionEvent e)
    {
        if (e.getSource()==NextPage)            //For accessing Non Academic course page
        {
            p1.setVisible(false);
            p2.setVisible(true);
            f.add(p2);
        }
            else if (e.getSource()==PreviousPage)       // for accessing Academic Course page
         {
          p1.setVisible(true);
          p2.setVisible(false);
          
         }
            if(e.getSource()==Add){                 //for using the add button on Academic Course
            ...
            if (newAC= true)
            {
                AC= new AcademicCourse(CourseID,CourseName,Duration,Level,Credit,NumberOfAssessment);
                data.add(AC);
            ...
            {
                  JOptionPane.showMessageDialog(p1,"Enter the correct Statement!");  
            }
            }
            else if (e.getSource()==nAdd)       //for using the add button of non academic course
            {
                String CourseID="";
                String CourseName="";
                int Duration=0;
            ...
            catch(Exception ex)
            {
             ...
             else if (e.getSource()==Register)              //for using the register button on Academic course
             {
                 ...
                 try
                 {
                     ...
                     for (Course CO:data)
                     {
                         ...
                         {
                             JOptionPane.showMessageDialog(f,"The Course ID does not match.");
                         }
                     }
                 }
                 catch (Exception ex)
             ...
             else if (e.getSource()==nRegister)             //for using the register button on Non Academic course
             {
                 String CourseID= "";
                 String CourseLeader= "";
                 ...
                 try
                 {
                     ...
                     for (Course CO:data)
                     {
                         ...
                         {
                             JOptionPane.showMessageDialog(f,"The CourseID does not match.");
                             break;
                         }
                     }
                 }
             ...
             else if (e.getSource()==nRemove)               //for using the remove button on non academic course
             {
                 String CourseID = nID.getText();
                 try {
                     for(Course C:data){
                         if (C.getCourseID().equals(CourseID))
                         {
             ...
             else if (e.getSource()==Clear)     // for using the clear button on academic course
             {
                 ID.setText("");
                 CName.setText("");
                 Time.setText("");
             ...
             else if (e.getSource()==nClear)        //for using the clear button on non academic course
             {
                 nID.setText("");
                 nCName.setText("");
                 nTime.setText("");
